...
export const relationsList = (username, isMainUser) => async dispatch =>{
    ...
    try {
        ...
        const res = await fetch(`http://localhost:8000/api/relations/relationsList/${username}`, {
        method: 'GET',
        headers: {
...
export const follow = (follower, followee) => async dispatch =>{
    ...
    try {
        ...
        const res = await fetch(`http://localhost:3000/api/relations/follow`, {
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
export const unfollow = (follower, followee) => async dispatch =>{
    ...
    try {
        ...
        const res = await fetch(`http://localhost:3000/api/relations/unfollow`, {
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
export const relation_status = (follower, followee) => async dispatch =>{
    ...
    try {
        ...
        const res = await fetch(`http://localhost:3000/api/relations/relationStatus`, {
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
